...
\begin{frame}{Simulation du broyeur à boulets - Méthodes particulaires}
    ...
    \begin{columns}[t]
        \begin{column}{0.5\textwidth}
            ...
            \end{center}
            \begin{figure}[b]
                \animategraphics[loop, autoplay, width=0.5\textwidth]{10}{../CSI_2024/image/rot_drum_dem/rot_drum_dem-}{0}{0}
            \end{figure}
            \begin{itemize}
                \item Méthode N-Body
        ...
        \begin{column}{0.5\textwidth}
            \only<1>{
                ...
                \end{center}
                \begin{figure}[b]
                    \animategraphics[loop, autoplay, width=0.6\textwidth]{15}{../../conference/images/rot_drum_mix/rot_drum_mix-}{0}{0}
                \end{figure}
                \begin{itemize}
...
\begin{frame}{Un exemple simplifié: méthode vortex~\footnotemark[1]}
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                \alt<2>{\animategraphics[loop, autoplay, width=0.85\textwidth]{5}{../../conference/images/dipole_particles/dipole_particles-}{0}{0}}
...
\begin{frame}{Application - dipôle de Lamb–Chaplygin}
    ...
    \begin{columns}
        \begin{column}{0.33\textwidth}
            \animategraphics[loop, autoplay, width=0.85\textwidth]{5}{../../conference/images/dipole_estimate/ensemble_dipole/ensemble_dipole-}{0}{0}%
        \end{column}
        \begin{column}{0.66\textwidth}
            \animategraphics[loop, autoplay, width=0.85\textwidth]{5}{../../conference/images/dipole_estimate/ensemble_estimate/ensemble_estimate-}{0}{0}%
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Application - assimilation}
    \begin{figure}[t]
        ...
        \begin{subfigure}{0.3\textwidth}
            \centering
            \alt<2>{%
                \animategraphics[loop, autoplay, height=0.3\textheight]{2}{../../conference/images/dipole_estimate/reference/reference-}{1}{1}
            }
        ...
        \begin{subfigure}{0.3\textwidth}
            \centering
            \alt<2>{%
                \animategraphics[loop, autoplay, height=0.3\textheight]{1}{../../conference/images/dipole_estimate/obs_no_noise/obs_no_noise-}{0}{0}
            }
        ...
        \begin{subfigure}{0.3\textwidth}
            \centering
            \alt<2>{%
                \animategraphics[loop, autoplay, height=0.3\textheight]{1}{../../conference/images/dipole_estimate/obs_noise/obs_noise-}{0}{0}
            }
    ...
    \begin{figure}[t]
        \begin{subfigure}{0.3\textwidth}
            \centering
            \alt<2>{%
                \animategraphics[loop, autoplay, height=0.3\textheight]{2}{../../conference/images/dipole_estimate/estimate/estimate-}{1}{1}
            }
        ...
        \begin{subfigure}{0.3\textwidth}
            \centering
            \alt<2>{%
                \animategraphics[loop, autoplay, height=0.3\textheight]{2}{../../conference/images/dipole_estimate/ensemble_sample/ensemble_sample-}{1}{1}
            }
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.55\textwidth}
            ...
            \begin{figure}[t]
                ...
                \only<4->{%
                    \animategraphics[loop, autoplay, width=0.85\textwidth]{5}{../../conference/images/vortex_centers_disperse/vortex_centers_}{0}{0}%
                }
                \only<3>{%
                    \animategraphics[loop, autoplay, width=0.85\textwidth]{5}{../../conference/images/vortex_centers_ref/vortex_centers_}{0}{0}%
                }
                \only<2>{%
                    \animategraphics[loop, autoplay, width=0.7\textwidth]{5}{../../conference/images/particles_ref/particles_ref_}{0}{0}
                }
                \only<1>{%
...
\begin{frame}{Remesh-EnKF}
    \begin{columns}[t]
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                \centering
                \animategraphics[loop, autoplay, width=\textwidth]{5}{../../conference/images/vortex_centers_remesh_enkf/vortex_centers_}{0}{0}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}
...
\begin{frame}{Part-EnKF}
    \begin{columns}[t]
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                \centering
                \animategraphics[loop, autoplay, width=\textwidth]{5}{../../conference/images/vortex_centers_part_enkf/vortex_centers_}{0}{0}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}
...
\begin{frame}{Correction des positions}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \animategraphics[loop, autoplay, width=\textwidth]{5}{../../conference/images/vortex_centers_align/vortex_centers_}{0}{0}
...
\begin{frame}{Correction des positions et des intensités}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \animategraphics[loop, autoplay, width=\textwidth]{5}{../../conference/images/vortex_centers_part_align/vortex_centers_}{0}{0}
                % \caption*{Vortex center trajectories}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
