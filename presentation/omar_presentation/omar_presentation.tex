        ...
        \begin{column}{0.6\textwidth}
            \begin{figure}
                ...
                \alt<2>{%
                    ...
                    \includegraphics[width=0.7\textwidth]{../../conference/images/particles_ref/particles_ref_0}%
                }
        ...
        \begin{column}{0.6\textwidth}
            \begin{exampleblock}{RBF Regression}
                \begin{eqnarray*}
                    ...
                    \Rightarrow \bm \Gamma_i^a &=& \argmin_{\bm \Gamma \in \mathbb R^{N_p}} \| \bm u_i - \Phi \bm \Gamma_i\|_2^2 + R(\bm \Gamma)
                \end{eqnarray*}
            \end{exampleblock}
        \end{column}
    \end{columns}
