...
We validate this assumption by varying the initial support of particles. Quantitatively, as observed in Figure~\ref{error_support}, the error estimate and dispersion decreases with an increase in the number of particles. At the level of 70 particles support a threshold is reached  Moreover, qualitatively examining the snapshot on the right reveals that the solution closely aligns with the reference.
