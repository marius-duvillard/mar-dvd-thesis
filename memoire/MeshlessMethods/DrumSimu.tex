...
\subsection{Définition de l'état d'une méthode sans maillage}
...
\subsubsection{Méthodes avec maillage différents}
\textcolor{red}{présenter des méthodes dans des cas où les membres ne partage pas la même discrétisation}
\subsubsection{Méthodes d'assimilation de mesures lagrangiennes}
