...
\chapter{Méthode de discrétisation particulaire}
...
\section{Méthodes des éléments discrets, \textit{Discrete element method}}~\label{sec:part_discret}
...
\subsection{Discrétisation à l'aide de particules}
...
\subsection{Méthode des points matériaux, \textit{Material Point Method} (MPM)}~\label{sec:mpm}
