...
\section{Définition d'une méthode d'assimilation d'ensemble variationnelle non-linéaire séquentiellen appliquée à la méthode vortex}~\label{sec:align_vortex}
