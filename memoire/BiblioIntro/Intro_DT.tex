...
En effet, le jumeau numérique peut être tour à tour vu comme un réplique haute fidélité capable d'émuler un système réel, un modèle de substitution rapide à évaluer pour l'optimisation, un outils de visualisation, ou bien un modèle d'intégration de données et d'analyse.
Notre définition est inspirée de celle proposé dans~\cite{AIAA2020} comme

\begin{definition}[Jumeau numérique]
