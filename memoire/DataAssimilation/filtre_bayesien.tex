...
\chapter{Assimilation de données pour la construction d'un jumeau numérique}

\section{Introduction}~\label{intro_da}

La construction d'un système expert ou jumeau numérique
...
L'assimilation de données trouve son origine en prédiction météorologique ou en océanographie~\cite{bocquet_introduction_2014}. Cependant, sa formulation mathématique se base sur l'inférence bayésienne, la théorie du contrôle et le calcul variationnel.
...
\subsection{Méthodes d'assimilation tenant compte de l'erreur d'alignement}
...
\section{Bilan - classification des filtres}
