    ...
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
            \begin{figure}
                ...
                \only<3-4>{\includegraphics[width=\textwidth]{images/obs_analasis.png}}
                \only<5>{\includegraphics[width=\textwidth]{images/obs_analasis2.png}}
                \only<6>{\includegraphics[width=\textwidth]{images/obs_analasis3.png}}
                \only<7>{\includegraphics[width=\textwidth]{images/obs_analasis4.png}}
                \only<8>{\includegraphics[width=\textwidth]{images/obs_analasis5.png}}
            \end{figure}
        \end{column}
    \end{columns}
    ...
    \begin{columns}[t]
        \begin{column}{0.7\textwidth}
            ...
            \begin{itemize}
                ...
                \item<1-> Particles $p$ : a position $\bm x_p$, an intensity $\Gamma_p$ and a kernel $\phi_h$
...
\begin{frame}{Problem}
    ...
    \begin{columns}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{figure}
                ...
                \only<5->{\caption*{\tiny Reference and samples set of one vortex}}
            \end{figure}
        \end{column}
    \end{columns}
    \vspace{-0.5cm}
    \begin{figure}
        \begin{subfigure}[t]{0.32\textwidth}
            ...
            \only<3->{\caption*{\tiny Particle positions}}
        \end{subfigure}
        \begin{subfigure}[t]{0.32\textwidth}
            \centering
            \includegraphics<4->[width=\textwidth]{images/vorticity_field.png}
            \only<4->{\caption*{\tiny Vorticity field of the three vortex at $t=0$}}
        \end{subfigure}
        \begin{subfigure}[t]{0.32\textwidth}
            \centering
            \includegraphics<4->[width=0.8\textwidth]{images/obs_velocity.png}
            \only<4->{\caption*{\tiny Observed induced velocity field at $t=0$}}
        \end{subfigure}
    \end{figure}
