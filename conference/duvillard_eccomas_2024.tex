    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.55\textwidth}
            ...
            \begin{figure}[t]
                ...
                \only<3->{%
                    \animategraphics[loop, autoplay, width=0.8\textwidth]{10}{images/vortex_centers_disperse/vortex_centers_}{0}{3}%{36}%
                }
                \only<2>{%
                    \animategraphics[loop, autoplay, width=0.8\textwidth]{10}{images/vortex_centers_ref/vortex_centers_}{0}{3}%{36}
                }
                \only<1>{%
                    \animategraphics[loop, autoplay, width=0.7\textwidth]{10}{images/particles_ref/particles_ref_}{0}{2}%{20}
                }
...
\begin{frame}{Strength correction}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            ...
            \begin{figure}
                \centering
                \animategraphics[loop, autoplay, width=0.9\textwidth]{10}{images/assim_trajectories_good.png/20715cd1b35d4fce9348da1439eea9c9S2mpHIHr3P6oQ4FS-}{0}{3}%{36}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}
