...
\begin{frame}{Without assimilation}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}[t]
                \centering
                \animategraphics[loop, autoplay, width=0.8\textwidth]{10}{images/non_assim_traj_good.png/a48dcf0a64ca45a6aeb8bc91b8cab709qQ7hWOIQS9YfBx4r-}{0}{73}
...
\begin{frame}{With assimilation}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{images/part_velo_cor.pdf}
...
\begin{frame}{With assimilation}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \centering
                \animategraphics[loop, autoplay, width=0.8\textwidth]{10}{images/assim_trajectories_good.png/20715cd1b35d4fce9348da1439eea9c9S2mpHIHr3P6oQ4FS-}{0}{73}
            \end{figure}
            % \caption*{Vortex center trajectories}
        \end{column}
        \begin{column}{0.5\textwidth}
